...
##
pwd = '123456'
md5_pwd=encode_md5_pwdsalt(pwd,encode_md5_pwd('y'+'707c'+'x')+'2020')  ###加密后的值32位
print(md5_pwd)
print(len(md5_pwd))
time.sleep(20)
...
for weishu in range(6,20):
    ...
    for i in r:
        ...
        if(re.match("^(?:(?=.*[a-zA-Z])(?=.*[0-9])).{%d}$" %weishu,str(oneline))!=None):
            ...
            md5_pwd2 = encode_md5_pwdsalt(str(passwd), encode_md5_pwd('y' + salt2 + 'x') + '2020')
